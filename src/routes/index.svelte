...
import {SignInModal} from "flowbite-svelte";
	...
	<div class="flex justify-between mx-auto space-x-40 max-w-7xl">
		<div class="flex flex-col w-1/2">
			...
			<h1 class="text-5xl font-bold leading-[84px]">
				Castmaps <span class="character-gradient">Heatmap</span> </h1>
			<p class="mt-8 leading-[36px]">
				Here is a live and interactive display of New Zealand fishing activities helping you make your decision on where to dive or fish while protecting coastal wildlife at the same time.
			</p>
			<button class="mt-12 w-fit px-9 py-[18px]"
			on:click={()=> {isOverlayOpen.set(true)}}>Quota Request</button>
		...
		<div class="relative flex items-center justify-center w-1/2">
			...
			width='100%' 
			height='650px' 
			src="https://api.mapbox.com/styles/v1/pepaah/cl3psxkyk002114llngn4yiy1.html?title=false&access_token=pk.eyJ1IjoicGVwYWFoIiwiYSI6ImNsMmVsN2J3ajAxcjgzbW5sM2U2ZDM3c2YifQ.IYomskkh0ryCojtyQnFXSA&zoomwheel=false#7.5/-43.2/173" 
			title="Basic" 
 ...
 <!-- tailwind css built into classes for image live weather image  -->
			<div class="flex flex-col items-center w-3/4 space-y-7 z-[2]">
				<div class="relative">
					...
					/>
					<img
						src="/images/objects/Other 02.png" width={124} height={124} alt="Other 02" class="relative z-10"/>
				</div>
<!-- H1 text and check it out button tailwind css -->
				...
				<button class="w-fit py-[18px] px-9"> <a href="https://www.windy.com/?-39.935,172.771,6"> Check it out now</a> </button>
...
<section class="py-40 my-0">
	<div class="flex justify-between mx-auto space-x-15 max-w-7xl">
		...
		<div class="flex flex-col space-y-10 w-1/2 z-[2]">
			<h1 class="text-4xl font-bold leading-[84px]"><span class="character-gradient">Local Buddy</span></h1>
			<p class="leading-9">
				Finding a fishing or diving buddy can be hard sometimes. We want to connect you with other locals with the same interests. Find out who is fishing or diving in your local area.
			</p>
			<button class="w-fit py-[18px] px-9"><a href="https://www.windy.com/?-39.935,172.771,6"> </a>Who is in the area</button>
		</div>
	</div>
</section>
...
<section class="py-40 my-1">
	<div class="flex justify-between mx-auto space-x-24 max-w-7xl">
		<div class="flex flex-col space-y-10 w-1/2 z-[2]">
			<h1 class="text-4xl font-bold leading-[84px]"><span class="character-gradient">Fish Species</span> of New Zealand</h1>
      <p class="leading-9">Over 1200 species of fish exist in marine ecosystems within New Zealand waters including tidal estuaries, seamounts, and reefs and of these around 110 species are endemic or native to New Zealand. 50% or less are found in open sea with around 61% of fish species found in coastal rock pools.</p>
			<p class="leading-9">
				Learn more about each fish species such as it's physical characteristics, typical locations in New Zealand and suitability for eating.
			</p>
			<button class="w-fit py-[18px] px-9"> <a href="/fish">Try It Now</a></button>
		</div>
		<div id =" logo" class="relative flex justify-end w-1/2">
			<img src="/images/new zealand-map-outlines.png" width={448} height={448} alt="Island" class="shadowfilter" />
		</div>
	</div>
</section>
...
<section class="py-10">
    ...
    <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="p-5">
          <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fisheries New Zealand</h5>
          <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">New Zealand's fisheries provide an important source of food for recreational, cultural, and commercial purposes. MPI uses science and research to help protect our marine resources.</p>
          <a href="https://fs.fish.govt.nz/Page.aspx?pk=91" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
          Read more
  ...
  <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Fisheries New Zealand</h5>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Maritime NZ is the national regulatory, compliance and response agency for the safety, security and environmental protection of coastal and inland waterways throughout New Zealand.</p>
        <a href="https://www.maritimenz.govt.nz/default.asp" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Read more
        <svg class="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
        </a>
    </div>
